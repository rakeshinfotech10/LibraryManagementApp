...
public class BookServiceImpl implements BookService {
    ...
    public BookServiceImpl(ExcelHelper excelhelper, BookRepository booksRepo,
    ...
    public BookDto updateBook(Book book) throws BookNotSaved {
            Book book1 = booksRepo.findByIsbn(book.getIsbn()).orElseThrow(()->new BookNotFound("Book not found for Isbn :" + book.getIsbn()));
            if (book1 != null) {
            	book1.setAuthor(book.getAuthor());
            	book1.setTitle(book.getTitle());
            	book1.getTags().addAll(book.getTags());
            	return bookTransformer.tranformToBookDto(booksRepo.save(book1));
            }
          return bookTransformer.tranformToBookDto(booksRepo.save(book));
    }
